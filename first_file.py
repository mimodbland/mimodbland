...
print('Hola Github desde local cuenta toviddfrei@gmail.com')
...
- Devuelve mensaje listado de todos los directorios y archivos 
- Ver que se ha creado el directorio .git
